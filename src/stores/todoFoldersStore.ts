...
export const useTodoFoldersStore = create<TodoFoldersStore>((set, get) => ({
  folders: (() => {
    const saved = localStorage.getItem('quicknotes_todo_folders');
  ...
  addFolder: (folder) => {
    set((state) => {
      ...
      localStorage.setItem('quicknotes_todo_folders', JSON.stringify(newFolders));
  ...
  deleteFolder: (id) => {
    set((state) => {
      ...
      localStorage.setItem('quicknotes_todo_folders', JSON.stringify(normalized));
